...
namespace RevitTimasBIMTools.Core
{
    internal class CutOpeningSettingsHandler : IExternalEventHandler
    {
        ...
        public IList<BuiltInCategory> GetFitrableCategories(Document document, Predicate<BuiltInCategory> collection)
        {
            ...
            return output.FindAll(collection);
        }


        private static bool FindComputer(BuiltInCategory bics)
        {
