...
namespace RevitTimasBIMTools.RevitUtils
{
    public class Utils
    {
        ...
        public static double MinLineLength => eps;

        public static double TolPointOnPlane => eps;
        ...
        /// </summary>
        public static bool IsLessOrEqual(double a, double b, double tolerance = eps)
        {
                               ...
                               out T ix, out T iy)
{
  ...
  return true;
        ...
        /// <summary>
        ///     Return the 3D intersection point between a line and a plane.
        ...
        /// </summary>
        public static XYZ LinePlaneIntersection(Line line, Plane plane, bool enforceResultOnLine, out double lineParameter)
        {
        ...
        ///     RevitAsync itself only supports Face.Transform(UV) that
            ...
            double height)
        {
            ...
            //{
            //  t.Start();
            //  DirectShape ds = DirectShape.CreateElement( Command.Doc, new Id( BuiltInCategory.OST_GenericModel ) );
        ...
        /// <summary>
        ///     Base units currently used internally by RevitAsync.
        /// </summary>
      ...
      UnitSymbolType u )
    {
      ...
      return s;
        ...
        #endregion // Using Obsolete pre-Forge Unit API Functionality Deprecated in RevitAsync 2021
    ...
    return e;
            ...
            try
            {
                ...
                // 'Autodesk.RevitAsync.DB.Reference.Element' is
                // obsolete: Property will be removed. Use
                // ActiveDocument.GetElement(Reference) instead.
        ...
        /// <param name="uidoc">Active activeDocument</param>
        ...
        {
            var sDir = $"{Environment.GetFolderPath(Environment.SpecialFolder.CommonApplicationData)}\\Autodesk\\RevitAsync\\Addins";
            ...
            var XElementAddIn = new XElement("AddIn", new XAttribute("Type", "AppController"));
    ...
    public static class IEnumerableExtensions
    {
        ...
        ///     http://geekswithblogs.net/BlackRabbitCoder/archive/2011/03/31/color.net-toolbox-adding-a-tohashset-extension-method.aspx
        /// </summary>
    ...
    public static class JtElementExtensionMethods
    {
        ...
        /// <summary>
        ///     Return the curve from a RevitAsync database Element
    ...
    public static class JtLineExtensionMethods
    {
        ...
        /// </summary>
        public static bool Contains(this Line line, XYZ p, double tolerance = Utils.eps)
        {
    ...
    public static class JtPlaneExtensionMethods
    {
        ...
        public static XYZ ProjectOnto(this Plane plane, XYZ p)
        {
            ...
            Debug.Assert(
                Utils.IsZero(plane.SignedDistanceTo(q)),
    ...
    public static class JtEdgeArrayExtensionMethods
    {
        ...
        ///     approximation determined by RevitAsync.
        /// </summary>
    ...
    public static class CompatibilityMethods
    {
        ...
        #endregion // Autodesk.RevitAsync.DB.FamilySymbol
        ...
        #endregion // Autodesk.RevitAsync.DB.InternalDefinition
        ...
        #endregion // Autodesk.RevitAsync.DB.Part
        ...
        #endregion // Autodesk.RevitAsync.DB.Wall
        ...
        #endregion // Autodesk.RevitAsync.DB.ActiveDocument
        ...
        #endregion // Autodesk.RevitAsync.DB.Element
            ...
            this Selection sel, Document doc)
        {
            ...
            {
                value = ((IEnumerable)t
                        .GetProperty("ElementList").GetValue(sel, null)).Cast<Element>()
                    .ToList();
            }
        ...
        #endregion // Autodesk.RevitAsync.UI.Selection.Selection
        ...
        #endregion // Autodesk.RevitAsync.DB.View
        ...
        #endregion // Autodesk.RevitAsync.DB.Viewplan
    }
