...
{
    internal sealed class CutVoidIntersectManager : IDisposable
    {
        ...
        private static CancellationToken cancelToken = CutVoidOpeningViewModel.CancelToken;
